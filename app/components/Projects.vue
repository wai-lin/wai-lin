		...
		<div class="max-w-6xl mx-auto">
			...
			<div class="text-center mb-16 animate-fade-in-up">
				<h2 class="text-4xl sm:text-5xl font-bold mb-4 text-slate-900 dark:text-white">
					Featured <span
						class="bg-linear-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Projects</span>
				</h2>
			...
			<div class="grid md:grid-cols-2 gap-8 mb-16">
				<button v-for="(project, index) in featuredProjects" :key="project.title"
					@click="expandProject = project"
					class="group cursor-pointer relative overflow-hidden rounded-2xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-blue-600 dark:hover:border-blue-400 transition-all duration-300 hover:shadow-2xl animate-fade-in-up text-left"
					:style="{ animationDelay: `${index * 100}ms` }">
					<!-- Image -->
					<div
						class="relative h-48 overflow-hidden bg-linear-to-br from-blue-500 to-cyan-500">
					...
					<div class="p-6">
						<h3
							class="text-lg font-bold mb-2 text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
							{{ project.title }}
						</h3>
						...
						<div class="flex flex-wrap gap-1">
							...
							<span v-if="project.tags.length > 3"
								class="text-xs px-2 py-1 text-slate-500 dark:text-slate-400">
			...
			<div v-if="otherProjects.length > 0">
				...
				<div class="grid md:grid-cols-3 gap-6">
					<a v-for="project in otherProjects" :key="project.title" href="#"
						...
						<h4
							class="text-lg font-bold mb-2 text-slate-900 dark:text-white group-hover:text-blue-600 transition-colors">
							{{ project.title }}
						</h4>
						<p class="text-sm text-slate-600 dark:text-slate-400 mb-4 line-clamp-2">
							{{ project.description }}
		...
		<Teleport to="body">
			<div v-if="expandProject"
				...
				<div
					...
					<div
						class="relative h-64 overflow-hidden bg-linear-to-br from-blue-500 to-cyan-500">
						<img :src="expandProject.image" :alt="expandProject.title"
							class="w-full h-full object-cover" />
						<button @click="expandProject = null"
					...
					<div class="p-8">
						...
						<div class="mb-6">
							...
							<div class="flex flex-wrap gap-2">
								<span v-for="tag in expandProject.tags" :key="tag"
						...
						<div class="flex gap-3">
							<a v-for="link in expandProject.links" :key="link.label"
